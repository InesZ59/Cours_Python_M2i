...
```bash
multipass info srv-linux-exo2          # la VM existe (notez son IPv4 au passage)
IPv4:     172.25.221.230
ssh srv-linux 'echo acces OK'     # la connexion par clé en tant que deploy fonctionne
'''
$ ssh srv-linux-exo2 'echo acces OK'

ssh: Could not resolve hostname srv-linux-exo2: Name or service not known
'''retour exercice 4.1
$ ssh -i ~/.ssh/formation_ed25519 deploy@172.25.221.230
après plusieurs essaies:
The authenticity of host '172.25.221.230 (172.25.221.230)' can't be established.
ED25519 key fingerprint is: SHA256:9k993BvPRcI0MKBtYJkF1eoL+xOg5Z5ZbPuo6POlPrE
This host key is known by the following other names/addresses:
    ~/.ssh/known_hosts:1: 172.29.111.246
    ~/.ssh/known_hosts:4: 172.31.13.149
    ~/.ssh/known_hosts:5: 172.25.212.174
    ~/.ssh/known_hosts:7: 172.25.217.158
Are you sure you want to continue connecting (yes/no/[fingerprint])?yes
Warning: Permanently added '172.25.221.230' (ED25519) to the list of known hosts.
Connection closed by 172.25.221.230 port 22

test indiqué dans indice : 
ubuntu@srv-linux-exo2:~$ sudo ls -la /home/deploy/.ssh
total 16
drwx------ 2 deploy deploy 4096 Jul 26 15:55 .
drwxr-x--- 6 deploy deploy 4096 Jul 23 16:33 ..
-rw------- 1 deploy deploy  106 Jul 26 15:55 authorized_keys
-rw-r--r-- 1 deploy deploy   45 Jul 26 12:09 uthorized_keys

remis : 
sudo chown -R deploy:deploy /home/deploy/.ssh
sudo cat /home/deploy/.ssh/authorized_keys | wc -l
2

Autre_test: 
sudo journalctl -u ssh -n 20
Jul 26 15:34:12 srv-linux-exo2 systemd[1]: Stopping ssh.service - OpenBSD Secure Shell server...
Jul 26 15:34:12 srv-linux-exo2 systemd[1]: ssh.service: Deactivated successfully.
Jul 26 15:34:12 srv-linux-exo2 systemd[1]: Stopped ssh.service - OpenBSD Secure Shell server.
-- Boot 403be49e25f8479e8b11fa3a72784abd --
Jul 26 15:35:08 srv-linux-exo2 systemd[1]: Starting ssh.service - OpenBSD Secure Shell server...
Jul 26 15:35:08 srv-linux-exo2 sshd[933]: Server listening on 0.0.0.0 port 22.
Jul 26 15:35:08 srv-linux-exo2 sshd[933]: Server listening on :: port 22.
Jul 26 15:35:08 srv-linux-exo2 systemd[1]: Started ssh.service - OpenBSD Secure Shell server.
Jul 26 15:35:08 srv-linux-exo2 sshd[934]: Accepted publickey for ubuntu from 172.25.208.1 port 54945 >
Jul 26 15:35:08 srv-linux-exo2 sshd[934]: pam_unix(sshd:session): session opened for user ubuntu(uid=>
Jul 26 15:35:38 srv-linux-exo2 sshd[1054]: Accepted publickey for ubuntu from 172.25.208.1 port 54959>
Jul 26 15:35:38 srv-linux-exo2 sshd[1054]: pam_unix(sshd:session): session opened for user ubuntu(uid>
Jul 26 15:45:44 srv-linux-exo2 sshd[1163]: Accepted publickey for ubuntu from 172.25.208.1 port 65014>
Jul 26 15:45:44 srv-linux-exo2 sshd[1163]: pam_unix(sshd:session): session opened for user ubuntu(uid>
Jul 26 15:45:45 srv-linux-exo2 sshd[1163]: pam_unix(sshd:session): session closed for user ubuntu
Jul 26 15:55:06 srv-linux-exo2 sshd[1270]: Accepted publickey for ubuntu from 172.25.208.1 port 63389>
Jul 26 15:55:06 srv-linux-exo2 sshd[1270]: pam_unix(sshd:session): session opened for user ubuntu(uid>
Jul 26 16:34:20 srv-linux-exo2 sshd[1436]: Connection closed by authenticating user deploy 172.25.208>
Jul 26 16:35:35 srv-linux-exo2 sshd[1443]: Connection closed by authenticating user deploy 172.25.208>
Jul 26 16:37:07 srv-linux-exo2 sshd[1445]: Accepted publickey for ubuntu from 172.25.208.1 port 50122>
Jul 26 16:37:07 srv-linux-exo2 sshd[1445]: pam_unix(sshd:session): session opened for user ubuntu(uid>
lines 1-21/21 (END)
